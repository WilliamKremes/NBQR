...
def index():
    ...
    if request.method == "POST":
        try:
            ...
            # Coordenadas finais (opcional, mas obrigatório para espargimento/gerador)
    ...
    if agente in agentes_nao_persistentes:
        ...
        # Para espargimento/gerador, source_final é obrigatório
        ...
        executar_predicao_persistente(
            ...
            wind_direction,
            meio_de_lancamento=meio,
            source_final=source_final  # Passa source_final
        )
    else:
